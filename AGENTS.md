...
Layer 3   SHARED SERVICES     skills any persona can call inline
                              note-taker · render · export · news · scribe · research · reminders
```
...
| Layer 3 services (note-taker, render, export, news, scribe, research, reminders) | Same shape as inner skills — `.pi/skills/<name>/SKILL.md`, available under every persona. |
